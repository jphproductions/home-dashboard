...
print_next_steps() {
    ...
    echo "Next steps:"
    echo ""
    printf "1. \033[1;33mGet Spotify Refresh Token:\033[0m\n"
    ...
    echo ""
    printf "2. \033[1;33mReboot your Raspberry Pi:\033[0m\n"
    echo "   sudo reboot"
    echo ""
    printf "3. \033[1;33mAfter reboot:\033[0m\n"
    echo "   - Dashboard should auto-start in kiosk mode"
    echo "   - Access from other devices: http://$(hostname).local:8000"
    echo ""
    printf "\033[0;34mUseful Commands:\033[0m\n"
